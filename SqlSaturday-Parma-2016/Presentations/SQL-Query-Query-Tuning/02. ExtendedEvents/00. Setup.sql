...
-- https://gist.github.com/peschkaj/05009bc84473041be714
--

USE [master];
GO

CREATE EVENT SESSION [query_performance] 
ON SERVER 
	...
	ADD TARGET package0.event_file
		(
			SET filename=N'C:\Demos\Sessions\query_performance.xel',
			max_file_size=(64),
			max_rollover_files=(5),
			metadatafile=N'C:\Demos\Sessions\query_performance.xem'
		)
	WITH 
		(
			MAX_MEMORY=4096 KB,
...
-- Next step: run some workload (for example AdventureWorks2014 workload.sql)
